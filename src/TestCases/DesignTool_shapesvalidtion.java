...
public class DesignTool_shapesvalidtion extends Utility {
	
	public static void DesignTool_shapesvalidtion(String File_TestData) throws Throwable
	{
...
Thread.sleep(5000);
//JOptionPane.showConfirmDialog(null, null);
                        clickjavascriptelement(driver,driver.findElement(By.xpath("(//*[@class='spride-svg'])[7]")));
 

                        Thread.sleep(15000);

                       List<WebElement> imgdata = driver.findElements(By.xpath("//*[@data-target='shape']"));	
